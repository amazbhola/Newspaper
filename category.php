        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post-container">
                    ...
                    $cat_id = $_GET['cat_id'];
                    $sql_cat_name = "SELECT * FROM category WHERE category_id = $cat_id";
                    $cat_name_result = mysqli_query($conn, $sql_cat_name);
                    if ($cat_name = mysqli_fetch_assoc($cat_name_result)) {
                        $cat_name = $cat_name['category_name'];
                        echo "<h2 class='page-heading'>$cat_name</h2>";
                    }
                    ?>
                    ...
                    $limit = 4;
                    $offset = ($page - 1) * $limit;
                    $sql = "SELECT post.post_id,  post.title, post.description, post.category, post.author, post.post_date, category.category_name, user.username, post.post_img FROM post 
