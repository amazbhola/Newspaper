<div id="sidebar" class="col-md-4">
    ...
    <div class="recent-post-container">
        ...
        include 'config.php';
        $limit=3;
         $sql = "SELECT post.post_id,  post.title, post.category, post.post_date, category.category_name,  post.post_img FROM post 
        ...
        <div class="recent-post">
            <a class="post-img" href="single.php?id=<?php echo $row['post_id'] ?>">
                <img src="admin/uploads/<?php echo $row['post_img'] ?>" alt=""/>
            </a>
